    ...
    while (d != null) {
        ...
        <li class="ks-item" id="ChatListItem">
            ...
            <span class="ks-avatar">
                <img src="./default_user.jpg" width="36" height="36" id="Image"></img>
            </span>
                <div class="ks-body">
                    <div class="ks-name">
...
let Chatnode = new LinkedList(["Shresth", "Hi!Whassup?"]);
Chatnode = new_data(["Pragya", "Hola!"], Chatnode)
Chatnode = new_data(["Harshita", "Hello!"], Chatnode)
traverse(Chatnode)
